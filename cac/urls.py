...
urlpatterns = [
    ...
    path('administracion/posteos/editar/<int:id_posteo>', views.posteos_editar,name='posteos_editar'),
    path('administracion/posteos/eliminar/<int:id_posteo>', views.posteos_eliminar,name='posteos_eliminar'),
